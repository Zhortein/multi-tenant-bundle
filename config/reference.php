 ...
 * }
 * @psalm-type ZhorteinMultiTenantConfig = array{
 *     tenant_entity?: scalar|Param|null, // The fully qualified class name of your tenant entity // Default: "App\\Entity\\Tenant"
 *     resolver?: "path"|"subdomain"|"header"|"query"|"domain"|"hybrid"|"dns_txt"|"chain"|"custom"|Param, // The tenant resolution strategy to use // Default: "path"
 *     resolver_chain?: array{
 *         order?: list<"path"|"subdomain"|"header"|"query"|"domain"|"hybrid"|"dns_txt"|Param>,
 *         strict?: bool|Param, // Whether to use strict mode (throw exceptions on failure/ambiguity) // Default: true
 *         header_allow_list?: list<scalar|Param|null>,
 *     },
 *     default_tenant?: scalar|Param|null, // Default tenant slug to use when no tenant is resolved // Default: null
 *     require_tenant?: bool|Param, // Whether to require a tenant for all requests // Default: false
 *     subdomain?: array{
 *         base_domain?: scalar|Param|null, // The base domain for subdomain resolution // Default: "localhost"
 *         excluded_subdomains?: list<scalar|Param|null>,
 *     },
 *     header?: array{
 *         name?: scalar|Param|null, // HTTP header name to use for tenant resolution // Default: "X-Tenant-Slug"
 *     },
 *     query?: array{
 *         parameter?: scalar|Param|null, // Query parameter name to use for tenant resolution // Default: "tenant"
 *     },
 *     domain?: array{
 *         domain_mapping?: array<string, scalar|Param|null>,
 *     },
 *     hybrid?: array{
 *         domain_mapping?: array<string, scalar|Param|null>,
 *         subdomain_mapping?: array<string, scalar|Param|null>,
 *         excluded_subdomains?: list<scalar|Param|null>,
 *     },
 *     dns_txt?: array{
 *         timeout?: int|Param, // DNS query timeout in seconds // Default: 5
 *         enable_cache?: bool|Param, // Whether to enable DNS result caching for performance // Default: true
 *     },
 *     database?: array{
 *         strategy?: "shared_db"|"multi_db"|Param, // Database strategy: shared_db (single database with tenant_id filtering) or multi_db (separate databases per tenant) // Default: "shared_db"
 *         enable_filter?: bool|Param, // Whether to enable the Doctrine tenant filter (shared_db mode only) // Default: true
 *         auto_tenant_id?: bool|Param, // Automatically add tenant_id to entities with #[AsTenantAware] (shared_db mode only) // Default: true
 *         connection_prefix?: scalar|Param|null, // Connection name prefix for multi_db mode (e.g., tenant_acme) // Default: "tenant_"
 *         rls?: array{
 *             enabled?: bool|Param, // Enable PostgreSQL Row-Level Security (RLS) for defense-in-depth (shared_db mode only) // Default: false
 *             session_variable?: scalar|Param|null, // PostgreSQL session variable name to store current tenant ID // Default: "app.tenant_id"
 *             policy_name_prefix?: scalar|Param|null, // Prefix for RLS policy names // Default: "tenant_isolation"
 *         },
 *     },
 *     cache?: array{
 *         pool?: scalar|Param|null, // Cache pool service to use for tenant settings // Default: "cache.app"
 *         ttl?: int|Param, // Cache TTL in seconds for tenant settings // Default: 3600
 *     },
 *     mailer?: array{
 *         enabled?: bool|Param, // Enable tenant-aware mailer configuration // Default: true
 *         add_tenant_id_header?: bool|Param, // Opt in to the public X-Tenant-ID email header // Default: false
 *         add_tenant_name_header?: bool|Param, // Opt in to the public X-Tenant-Name email header independently // Default: false
 *         fallback_dsn?: scalar|Param|null, // Fallback mailer DSN when tenant has no specific configuration // Default: null
 *         fallback_from?: scalar|Param|null, // Fallback from address when tenant has no specific configuration // Default: null
 *         fallback_sender?: scalar|Param|null, // Fallback sender name when tenant has no specific configuration // Default: null
 *     },
 *     messenger?: array{
 *         enabled?: bool|Param, // Enable tenant-aware messenger configuration // Default: true
 ...
 *     },
 *     fixtures?: array{
 *         enabled?: bool|Param, // Enable tenant-aware fixtures loading // Default: true
 *     },
 *     events?: array{
 *         dispatch_database_switch?: bool|Param, // Dispatch events when switching tenant databases // Default: true
 *     },
 *     storage?: array{
 *         enabled?: bool|Param, // Enable tenant-aware file storage // Default: true
 *         type?: "local"|"s3"|"custom"|Param, // Storage type to use // Default: "local"
 *         local?: array{
 *             base_path?: scalar|Param|null, // Base path for local storage // Default: "%kernel.project_dir%/var/storage"
 *             base_url?: scalar|Param|null, // Base URL for accessing stored files // Default: "/uploads"
 *         },
 *         s3?: array{
 *             bucket?: scalar|Param|null, // S3 bucket name // Default: null
 *             region?: scalar|Param|null, // S3 region // Default: "us-east-1"
 ...
 *     },
 *     listeners?: array{
 *         request_listener?: bool|Param, // Enable automatic tenant resolution from requests // Default: true
 *         doctrine_filter_listener?: bool|Param, // Enable automatic Doctrine filter configuration // Default: true
 *     },
 *     decorators?: array{
 *         cache?: array{
 *             enabled?: bool|Param, // Enable tenant-aware cache decorators (PSR-6 and PSR-16) // Default: true
 *             services?: list<scalar|Param|null>,
 *         },
 *         logger?: array{
 *             enabled?: bool|Param, // Enable tenant-aware logger processor // Default: true
 *             channels?: list<scalar|Param|null>,
 *         },
 *         storage?: array{
 *             enabled?: bool|Param, // Enable tenant-aware storage path helper // Default: true
 *             use_slug?: bool|Param, // Use tenant slug instead of ID for path prefixing // Default: false
 *             path_separator?: scalar|Param|null, // Path separator to use for tenant directories // Default: "/"
 *         },
 *     },
 * }
